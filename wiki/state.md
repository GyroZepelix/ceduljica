...
| --- | --- | --- | --- | --- | --- |
| `https://git.dgjalic.com/dgjalic/repo-wiki-template` | Protocol 2.2.1/schema-2 template installer | Forgejo repository | 2026-09-24 | `AGENTS.md`, `spec/`, `wiki/` | Installed lean repo wiki template. |
